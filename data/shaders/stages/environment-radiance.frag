...
/**
 * Taken from https://github.com/SaschaWillems/Vulkan-glTF-PBR/blob/master/data/shaders/prefilterenvmap.frag
 * Original by Sascha Willems under MIT license.
 *
 * Slightly adjusted for our engine.
 */
...
layout(push_constant) uniform PushConstants {
	...
	layout (offset = 68) uint samplesCount;
} pushConstants;
...
// @fixme This could be taken from global func, shared with rm-material.shmag
