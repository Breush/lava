...
int main(void)
{
    ...
    // GLB mesh maker
    {
        ...
        entity.get<sill::TransformComponent>().translate({0.f, -1.2f, 0
    });
}
...
// Plane mesh maker
{
    ...
    entity.get<sill::TransformComponent>().translate0.f, 1.2f, 0.f
});
}
...
// Sphere mesh maker
{
    ...
    entity.get<sill::TransformComponent>().translate1 .2f, 0.f, 0.f
});
}
