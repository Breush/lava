...
/// in lava::NonCopyable so they will end up being inaccessible in both
/// cases. Thus you can use a shorter syntax for inheriting from it
/// (see below).
///
/// Usage example:
/// \code
/// class MyNonCopyableClass : lava::NonCopyable
/// {
///     ...
/// };
/// \endcode
...
/// and to use lava::NonCopyable when necessary to prevent
