...
///
/// lava::VideoMode provides a static function for retrieving
...
///
/// Additionally, lava::VideoMode provides a static function
...
/// std::vector<lava::VideoMode> modes = lava::VideoMode::getFullscreenModes();
/// for (std::size_t i = 0; i < modes.size(); ++i)
/// {
///     lava::VideoMode mode = modes[i];
///     std::cout << "Mode #" << i << ": "
...
/// lava::VideoMode desktop = lava::VideoMode::getDesktopMode();
/// window.create(lava::VideoMode(1024, 768, desktop.bitsPerPixel), "SFML window");
/// \endcode
///
////////////////////////////////////////////////////////////
